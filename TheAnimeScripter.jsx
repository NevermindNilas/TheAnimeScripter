...
var TheAnimeScripter = (function() {
    ...
    */
    ...
    createDropdownField(panel1, "Interpolate Model", "Interpolate", ["Rife4.15", "-", "Rife4.14", "-" , "Rife4.13-Lite", "-", "Rife4.6", "-", "Rife4.15-NCNN", "-", "Rife4.14-NCNN", "-", "Rife4.13-Lite-NCNN", "-", "Rife4.6-NCNN", "-", "GMFSS"], "Choose which interpolation model you want to utilize, ordered by speed, GFMSS should only really be used on systems with 3080 / 4070 or higher, read more in INFO");
