"""
Vendored from https://github.com/soCzech/TransNetV2
Original file: inference-pytorch/transnetv2_pytorch.py
License: Apache-2.0 (Tomas Soucek, soCzech)

PyTorch port of TransNetV2 (Soucek & Lokoc, ACM MM 2024) - shot boundary
