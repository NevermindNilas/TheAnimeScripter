...
var dialog = (function() {
    ...
    var dialog = (panelGlobal instanceof Panel) ? panelGlobal : new Window("palette", undefined, undefined, {
        resizeable: true
    });
    ...
    var statictext1 = dialog.add("group", undefined, {
        name: "statictext1"
    });
    ...
    // =======================
    var InterpolateUpscaleGroup = dialog.add("group", undefined, {
        name: "InterpolateUpscaleGroup"
    });
    ...
    // INTERPOLATEDPANEL
    // =================
    var InterpolatedPanel = InterpolateUpscaleGroup.add("panel", undefined, undefined, {
        name: "InterpolatedPanel"
    });
    ...
    // INTERPOLATEGROUP
    // ================
    var InterpolateGroup = InterpolatedPanel.add("group", undefined, {
        name: "InterpolateGroup"
    });
    ...
    var InterpolateButton = InterpolateGroup.add("button", undefined, undefined, {
        name: "InterpolateButton"
    });
    ...
    // UPSCALEPANEL
    // ============
    var UpscalePanel = InterpolateUpscaleGroup.add("panel", undefined, undefined, {
        name: "UpscalePanel"
    });
    ...
    // UPSCALEGROUP
    // ============
    var UpscaleGroup = UpscalePanel.add("group", undefined, {
        name: "UpscaleGroup"
    });
    ...
    var UpscaleButton = UpscaleGroup.add("button", undefined, undefined, {
        name: "UpscaleButton"
    });
    ...
    // EXTRAANDFIRSTTIME
    // =================
    var ExtraAndFirstTime = dialog.add("group", undefined, {
        name: "ExtraAndFirstTime"
    });
    ...
    // EXTRA
    // =====
    var Extra = ExtraAndFirstTime.add("panel", undefined, undefined, {
        name: "Extra"
    });
    Extra.text = "Extra";
    ...
    // DEDUPSEGMENTGROUP
    // =================
    var DedupSegmentGroup = Extra.add("group", undefined, {
        name: "DedupSegmentGroup"
    });
    ...
    var DedupButton = DedupSegmentGroup.add("button", undefined, undefined, {
        name: "DedupButton"
    });
    DedupButton.text = "Dedup";
    DedupButton.preferredSize.width = 69;

    var SegmentButton = DedupSegmentGroup.add("button", undefined, undefined, {
        name: "SegmentButton"
    });
    ...
    // ONFIRSTRUNONLY
    // ==============
    var OnFirstRunOnly = ExtraAndFirstTime.add("panel", undefined, undefined, {
        name: "OnFirstRunOnly"
    });
    ...
    // GROUP1
    // ======
    var group1 = OnFirstRunOnly.add("group", undefined, {
        name: "group1"
    });
    ...
    var OutputButton = group1.add("button", undefined, undefined, {
        name: "OutputButton"
    });
    ...
    var MainpyButton = group1.add("button", undefined, undefined, {
        name: "MainpyButton"
    });
    ...
    // CHAINPANEL
    // ==========
    var chainPanel = dialog.add("panel", undefined, undefined, {
        name: "chainPanel"
    });
    ...
    // GROUP1
    // ======
    var group1 = chainPanel.add("group", undefined, {
        name: "group1"
    });
    group1.orientation = "row";
    group1.alignChildren = ["left", "center"];
    ...
    var chainButton = group1.add("button", undefined, undefined, {
        name: "chainButton"
    });
    ...
    var dedupCheckmark = group1.add("checkbox", undefined, undefined, {
        name: "dedupCheckmark"
    });
    dedupCheckmark.text = "Deduplicate";
    dedupCheckmark.preferredSize.width = 86;

    var upcsaleCheckmark = group1.add("checkbox", undefined, undefined, {
        name: "upcsaleCheckmark"
    });
    upcsaleCheckmark.text = "Upscale";
    upcsaleCheckmark.preferredSize.width = 64;

    var interpolateCheckmark = group1.add("checkbox", undefined, undefined, {
        name: "interpolateCheckmark"
    });
    ...
    // DIALOG
    // ======
    var settingsGroup = dialog.add("group", undefined, {
        name: "settingsGroup"
    });
    ...
    // SETTINGSPANEL
    // =============
    var SettingsPanel = settingsGroup.add("panel", undefined, undefined, {
        name: "SettingsPanel"
    });
    ...
    // GROUP2
    // ======
    var group2 = SettingsPanel.add("group", undefined, {
        name: "group2"
    });
    ...
    var ChooseUpscalerText = group2.add("statictext", undefined, undefined, {
        name: "ChooseUpscalerText"
    });
    ...
    var DropdownUpscaler = group2.add("dropdownlist", undefined, undefined, {
        name: "DropdownUpscaler",
        items: DropdownUpscaler_array
    });
    ...
    var divider3 = group2.add("panel", undefined, undefined, {
        name: "divider3"
    });
    divider3.alignment = "fill";

    var ChooseNrThreads = group2.add("statictext", undefined, undefined, {
        name: "ChooseNrThreads"
    });
    ...
    // GROUP3
    // ======
    var group3 = SettingsPanel.add("group", undefined, {
        name: "group3"
    });
    ...
    var ChooseCuganText = group3.add("statictext", undefined, undefined, {
        name: "ChooseCuganText"
    });
    ...
    var DropdownCugan = group3.add("dropdownlist", undefined, undefined, {
        name: "DropdownCugan",
    ...
    var divider5 = group3.add("panel", undefined, undefined, {
        name: "divider5"
    });
    divider5.alignment = "fill";

    var ChooseSwinIRText = group3.add("statictext", undefined, undefined, {
        name: "ChooseSwinIRText"
    });
    ...
    var DropdownSwinIr = group3.add("dropdownlist", undefined, undefined, {
        name: "DropdownSwinIr",
    ...
    // GROUP4
    // ======
    var group4 = SettingsPanel.add("group", undefined, {
        name: "group4"
    });
    ...
    var ChooseSegmentText = group4.add("statictext", undefined, undefined, {
        name: "ChooseSegmentText"
    });
    ...
    var DropdownSegment = group4.add("dropdownlist", undefined, undefined, {
        name: "DropdownSegment",
        items: DropdownSegment_array
    });
