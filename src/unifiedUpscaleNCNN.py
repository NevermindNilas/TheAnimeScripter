    ...
    def __init__(
        ...
        match (self.upscaleMethod, self.upscaleFactor, self.cuganKind):
            ...
            case ("cugan-ncnn", 4, "conservative"):
                self.modelId = 20
            case ("cugan-ncnn", 2, "no-denoise"):
                self.modelId = 24
            case ("cugan-ncnn", 3, "no-denoise"):
                self.modelId = 28
            case ("cugan-ncnn", 4, "no-denoise"):
                self.modelId = 21
            case ("cugan-ncnn", 2, "denoise1x"):
                self.modelId = 14
            case ("cugan-ncnn", 2, "denoise2x"):
                self.modelId = 15
            case ("cugan-ncnn", 2, "denoise3x"):
                self.modelId = 25
            case ("cugan-ncnn", 3, "denoise3x"):
                self.modelId = 26
            case ("cugan-ncnn", 4, "denoise3x"):
                self.modelId = 22
