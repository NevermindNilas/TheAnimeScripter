...
## [2.5.5] - 2026-01-07
### New
- Added `socket-io` and `eventlent` comms to the backend facilitating the development of the Adobe Edition.
...
### Fixed
- Fixed an issue where Github Sponsors would run into an infinite loop error.
