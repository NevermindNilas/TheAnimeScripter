...
### Added
- New encoding options, x264_nelux, x265_nelux and av1_nelux, which utilize the Nelux encoder for improved performance and quality.
...
- Bumped nelux to `0.10.1` for improved stability and performance.
