...
- A major redesign of the video encoding pipeline resulting in lower CPU usage, lower memory consumption and better encoding performance across the board.
