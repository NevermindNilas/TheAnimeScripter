...
- More robust Try/Except statements in order to lower the time needed from beginning to code execution.
- More robust cuda syncrhonization to improve reliability
