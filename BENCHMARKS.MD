### Benchmarks ran with the latest .exe file at the time, benchmark.exe or benchmark.py tool, no encoding and on a 1920x1080p video with FP16 or BF16 on for all runs.
